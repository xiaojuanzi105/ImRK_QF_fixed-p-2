...
%%
loglog(1:N+1, ImF1,'r-','LineWidth', 1.5);hold on
loglog(1:N+1, ImF2,'b-','LineWidth', 1.5);hold on
loglog(1:N+1, ImF3,'k-','LineWidth', 1.5);hold on
% loglog(1:N+1, ExFF,'b--','LineWidth', 1.5);
loglog(1:N+1, ExF_NAG,'k:','LineWidth', 2.5);hold on;
loglog(1:N+1, ExF_GD,'k-.','LineWidth', 1.5);
